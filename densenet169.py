...
DENSENET_169_WEIGHTS_PATH = (r'https://github.com/vikaschouhan/DenseNet-Keras/releases/'
                             r'download/v1.0/densenet169_weights_tf.h5')
...
def DenseNet169(include_top=True,
    ...
    return __DenseNet169(classes=classes, include_top=include_top,
            load_weights=load_weights, input_tensor=input_tensor,
            input_shape=input_shape, pooling=pooling)
# enddef

def __DenseNet169(nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.5, dropout_rate=0.0,
    ...
    if load_weights:
        weights_path = get_file('densenet169_weights_tf.h5', DENSENET_169_WEIGHTS_PATH, cache_subdir='models')
